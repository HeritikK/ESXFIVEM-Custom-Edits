...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('securitas',0,'recruit','Tulokas',20,'{}','{}'),
	('securitas',1,'officer','Konstaapeli',40,'{}','{}'),
	('securitas',2,'sergeant','Ylikonstaapeli',60,'{}','{}'),
	('securitas',3,'lieutenant','Kersantti',85,'{}','{}'),
	('securitas',4,'boss','Komentaja',100,'{}','{}')
;
