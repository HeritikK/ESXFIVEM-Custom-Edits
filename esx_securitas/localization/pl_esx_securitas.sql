...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('securitas',0,'recruit','Posterunkowy',20,'{}','{}'),
	('securitas',1,'officer','Sierżant',40,'{}','{}'),
	('securitas',2,'sergeant','Aspirant',60,'{}','{}'),
	('securitas',3,'lieutenant','Komisarz',85,'{}','{}'),
	('securitas',4,'boss','Generalny Inspektor',100,'{}','{}')
;
