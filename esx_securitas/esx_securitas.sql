...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('securitas',0,'recruit','Recrue',20,'{}','{}'),
	('securitas',1,'officer','Officier',40,'{}','{}'),
	('securitas',2,'sergeant','Sergent',60,'{}','{}'),
	('securitas',3,'lieutenant','Lieutenant',85,'{}','{}'),
	('securitas',4,'boss','Commandant',100,'{}','{}')
;
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de securitas',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de securitas',110,1),
