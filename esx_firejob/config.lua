...
Config.FireStations = {
  ...
  LSFD = {
    ...
    AuthorizedVehicles = {
	  { name = 'typhoon', label = 'Fire Truck' },
	  { name = 'spartane', label = 'Fire Truck 2' },
	  { name = 'sterlingt', label = 'Fire Pumper' },
	  { name = 'tiller1', label = 'Fire Tiller Front' },
	  { name = 'tillertrailer', label = 'Fire Tiller Trailer' },
	  { name = 'quantum', label = 'Quantum Pierce' },	  
	  { name = 'firetahoe', label = 'Chief Car' },	  
    },

    Cloakrooms = {
      { x = 9999.99, y = -9999.99, z = 9999.99 }
    },
